...
@SuppressWarnings("CPD-START") public class StorylyEmojiButton extends AppCompatButton implements EmojiDisplayable {
  private float emojiSize;

  public StorylyEmojiButton(final Context context) {
    this(context, null);
  }

  public StorylyEmojiButton(final Context context, final AttributeSet attrs) {
    super(context, attrs);
    emojiSize = Utils.initTextView(this, attrs);
  }

  public StorylyEmojiButton(final Context context, final AttributeSet attrs, final int defStyleAttr) {
