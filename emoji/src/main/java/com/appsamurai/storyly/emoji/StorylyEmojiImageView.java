...
import com.appsamurai.storyly.emoji.listeners.OnEmojiClickListener;
import com.appsamurai.storyly.emoji.listeners.OnEmojiLongClickListener;
import com.vanniktech.emoji.R;

public final class StorylyEmojiImageView extends AppCompatImageView {
  ...
  public StorylyEmojiImageView(final Context context, final AttributeSet attrs) {
    super(context, attrs);
    ...
    if (!emoji.equals(currentEmoji)) {
      ...
      setOnClickListener(new OnClickListener() {
        @Override public void onClick(final View view) {
          if (clickListener != null) {
            clickListener.onEmojiClick(StorylyEmojiImageView.this, currentEmoji);
          }
        }
      });
      ...
      setOnLongClickListener(hasVariants ? new OnLongClickListener() {
        @Override public boolean onLongClick(final View view) {
          longClickListener.onEmojiLongClick(StorylyEmojiImageView.this, currentEmoji);
