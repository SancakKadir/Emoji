...
@SuppressWarnings("CPD-START") public class StorylyEmojiTextView extends AppCompatTextView implements EmojiDisplayable {
  private float emojiSize;

  public StorylyEmojiTextView(final Context context) {
    this(context, null);
  }

  public StorylyEmojiTextView(final Context context, final AttributeSet attrs) {
    super(context, attrs);
    emojiSize = Utils.initTextView(this, attrs);
  }

  public StorylyEmojiTextView(final Context context, final AttributeSet attrs, final int defStyleAttr) {
